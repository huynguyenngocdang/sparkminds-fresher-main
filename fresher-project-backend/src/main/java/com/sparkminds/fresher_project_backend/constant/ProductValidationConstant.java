...
public class ProductValidationConstant extends CommonValidationConstant{
    ...
    public static final String PRODUCT_PRICE_NOT_BLANK = "Product price " + VALIDATION_FAIL_NOT_BLANK;
    ...
    public static final String PRODUCT_QUANTITY_NOT_BLANK = "Product quantity " + VALIDATION_FAIL_NOT_BLANK;
