...
public class UserConstant extends CommonConstant {
    public static final String CREATE_USER_SUCCESSFUL = "User " + CREATE_SUCCESSFUL;
    public static final String CREATE_USER_FAIL = CREATE_FAIL + " user";
    public static final String INVALID_USER_ALREADY_EXIST = "User with this username already exists.";
    public static final String INVALID_USER_NOT_EXIST = "User with this username does not exists";
    public static final String INVALID_USER_PROFILE_NOT_EXIST = "User profile with this username does not exists";
    public static final String UPDATE_USER_SUCCESSFUL = "User " + UPDATE_SUCCESSFUL;
